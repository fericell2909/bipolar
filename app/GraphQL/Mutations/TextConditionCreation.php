...
class TextConditionCreation extends Mutation
{
    protected $attributes = [
        'name'        => 'products_conditions_text',
        'description' => 'Create a text condition',
    ];
    ...
    public function resolve($root, $args, $context, ResolveInfo $resolveInfo, Closure $getSelectFields)
    {
        ...
        $textCondition->uuid = Str::uuid();
        $textCondition->available = true;
        $textCondition->save();
        
        // return the new text condition.
        return $textCondition;
        //return TextCondition::where('id','>',0)->get();
    }
}

...
@section('content')
  <img src="{{ asset('storage/bipolar-images/assets/bipolar.png') }}" style="width: 100%;" class="img-responsive" alt="Bipolar">
  <div class="bipolar-page-container">
    ...
    <p>
      <a class="special-link" href="{{ route('landings.historico') }}">Aquí</a> un recorrido por todos nuestros
      bipolares desde el inicio!
    </p>
  </div>
@endsection
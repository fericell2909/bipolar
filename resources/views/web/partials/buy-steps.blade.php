<section class="container">
  <section class="bipolar-steps">
    @if($buyStatus = array_get($buyStatuses, config('constants.BUY_INCOMPLETE_STATUS')))
      <article class="bipolar-steps__one">
        <header class="bipolar-steps__one__line">
          <img src="{{
            !is_null(array_get($buyStatuses, config('constants.BUY_PICKUP_STATUS'))) || !is_null(array_get($buyStatuses, config('constants.BUY_SENT_STATUS')))
            ? asset('images/circle-on-hard-line.svg')
            : asset('images/circle-on-soft-line.svg') }}" alt="">
        </header>
    ...
    @elseif($buyStatus = array_get($buyStatuses, config('constants.BUY_PROCESSING_STATUS')))
      <article class="bipolar-steps__one">
        <header class="bipolar-steps__one__line">

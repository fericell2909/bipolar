<section class="container">
  <section class="bipolar-steps">
    @if($buyStatus = Illuminate\Support\Arr::get($buyStatuses, config('constants.BUY_PROCESSING_STATUS')))
    ...
    @endif
    @if($buy->showroom)
      @if($buyStatus = Illuminate\Support\Arr::get($buyStatuses, config('constants.BUY_PICKUP_STATUS')))
        <article class="bipolar-steps__one">
          <header class="bipolar-steps__one__line">
            <img src="{{ !is_null(Illuminate\Support\Arr::get($buyStatuses, config('constants.BUY_CULMINATED_STATUS'))) ? asset('images/circle-on-hard-line.svg') : asset('images/circle-on-soft-line.svg') }}" alt="">
          </header>
      ...
      @endif
    @else
      @if($buyStatus = Illuminate\Support\Arr::get($buyStatuses, config('constants.BUY_SENT_STATUS')))
        <article class="bipolar-steps__one">
          <header class="bipolar-steps__one__line">
            <img src="{{ !is_null(Illuminate\Support\Arr::get($buyStatuses, config('constants.BUY_TRANSIT_STATUS'))) ? asset('images/circle-on-hard-line.svg') : asset('images/circle-on-soft-line.svg') }}" alt="">
          </header>
      ...
      @endif
      @if($buyStatus = Illuminate\Support\Arr::get($buyStatuses, config('constants.BUY_TRANSIT_STATUS')))
        <article class="bipolar-steps__one">
          <header class="bipolar-steps__one__line">
            <img src="{{ !is_null(Illuminate\Support\Arr::get($buyStatuses, config('constants.BUY_CULMINATED_STATUS'))) ? asset('images/circle-on-hard-line.svg') : asset('images/circle-on-soft-line.svg') }}" alt="">
          </header>
      ...
      @endif
    @endif
    @if($buyStatus = Illuminate\Support\Arr::get($buyStatuses, config('constants.BUY_CULMINATED_STATUS')))
      <article class="bipolar-steps__one">
        <header class="bipolar-steps__one__line">

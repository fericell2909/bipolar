            ...
            <tr>
              <td>
               {{-- @if(\LaravelLocalization::getCurrentLocale() === 'es')
                <img src="bipolar-images/assets/mails/pedido-recibido-esp.jpg" style="max-width: 100%" alt="Bipolar">
                @elseif(\LaravelLocalization::getCurrentLocale() === 'en')
                <img src="bipolar-images/assets/mails/pedido-recibido-eng.jpg" style="max-width: 100%" alt="Bipolar">
                @endif--}}
              </td>
            </tr>
            <tr>

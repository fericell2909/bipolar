                      ...
                      <tr>
                        <td class="tc" style="box-sizing: border-box;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;padding-left: 8px;padding-right: 8px;font-family: Arial, Helvetica, sans-serif;font-size: 16px;color: #757575;text-align: center;line-height: inherit;">
                          @if(\LaravelLocalization::getCurrentLocale() === 'es')
                            <h3 style="font-family: Times, Helvetica, sans-serif;font-weight: bold;padding: 0;margin-left: 0;margin-right: 0;margin-top: 20px;margin-bottom: 0;color: #000000;font-size: 15px;line-height: 23px;">Te esperamos!</h3>
                          @elseif(\LaravelLocalization::getCurrentLocale() === 'en')
                            <h3 style="font-family: Times, Helvetica, sans-serif;font-weight: bold;padding: 0;margin-left: 0;margin-right: 0;margin-top: 20px;margin-bottom: 0;color: #000000;font-size: 15px;line-height: 23px;">We will wait for you!</h3>
                          @endif

                          @if(\LaravelLocalization::getCurrentLocale() === 'es')
                          <p style="font-family: Times, Helvetica, sans-serif;font-size: 16px;color: #000000;line-height: 23px;mso-line-height-rule: exactly;margin-top: 0;margin-bottom: 20px;">Puedes recoger tu pedido en Av. Santa Cruz 496 San Isidro de lunes a sábado de 11:30 a.m. a 8:00 p.m.</p>
                          @elseif(\LaravelLocalization::getCurrentLocale() === 'en')
                          <p style="font-family: Times, Helvetica, sans-serif;font-size: 16px;color: #000000;line-height: 23px;mso-line-height-rule: exactly;margin-top: 0;margin-bottom: 20px;">You can pick up your order at Av. Santa Cruz 496 San Isidro from Monday to Saturday from 11:30 a.m. at 8:00 p.m.</p>
                          @endif

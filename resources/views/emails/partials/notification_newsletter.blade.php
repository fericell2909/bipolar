      ...
      <tr>
        <td class="email_body tc" style="box-sizing: border-box;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;line-height: 100%;padding-left: 8px;padding-right: 8px;background-color: #eceff1;text-align: center;font-size: 0 !important;">
          ...
          <table role="presentation" class="content_section" width="100%" border="0" cellspacing="0" cellpadding="0" style="box-sizing: border-box;mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;width: 100%;max-width: 640px;margin: 0 auto;text-align: center;min-width: 0 !important;">
            <tbody>
              <tr>
                <td class="content_cell content_b tc" style="box-sizing: border-box;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;line-height: inherit;padding-left: 8px;padding-right: 8px;background-color: #fdbeb8;text-align: center;font-size: 0 !important;">
                      ...
                      <tr>
                        <td class="column_cell tc" style="box-sizing: border-box;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;padding-left: 8px;padding-right: 8px;font-family: Arial, Helvetica, sans-serif;font-size: 16px;color: #757575;text-align: center;line-height: inherit;">
                          @if(\LaravelLocalization::getCurrentLocale() === 'es')
                            <h3 style="font-family: Arial, Helvetica, sans-serif;font-weight: bold;padding: 0;margin-left: 0;margin-right: 0;margin-top: 20px;margin-bottom: 0;color: #000000;font-size: 15px;line-height: 23px;">Quieres tener acceso a pre-ventas y promociones especiales?</h3>
                          @elseif(\LaravelLocalization::getCurrentLocale() === 'en')
                            <h3 style="font-family: Arial, Helvetica, sans-serif;font-weight: bold;padding: 0;margin-left: 0;margin-right: 0;margin-top: 20px;margin-bottom: 0;color: #000000;font-size: 15px;line-height: 23px;">Do you want to have access to pre-sales and special offers?</h3>
                          @endif
                          @if(\LaravelLocalization::getCurrentLocale() === 'es')
                          <p style="font-family: Arial, Helvetica, sans-serif;font-size: 16px;color: #000000;line-height: 23px;mso-line-height-rule: exactly;margin-top: 0;margin-bottom: 20px;">Únete a nuestra lista exclusiva de whatsapp escribiéndonos <a href="https://api.whatsapp.com/send?phone=51965367385&amp;text=Hola%21%20Quisiera%20m%C3%A1s%20informaci%C3%B3n%20sobre%20Tus%20Servicios%20" target="_blank" style="color:#000000 !important; font-weight: bold; text-decoration: underline;">aquí.</a></p>
                          @elseif(\LaravelLocalization::getCurrentLocale() === 'en')
                          <p style="font-family: Arial, Helvetica, sans-serif;font-size: 16px;color: #000000;line-height: 23px;mso-line-height-rule: exactly;margin-top: 0;margin-bottom: 20px;">Join our exclusive WhatsApp list by writing to us <a href="https://api.whatsapp.com/send?phone=51965367385&amp;text=Hola%21%20Quisiera%20m%C3%A1s%20informaci%C3%B3n%20sobre%20Tus%20Servicios%20" target="_blank" style="color:#000000 !important; font-weight: bold; text-decoration: underline;">here.</a></p>
                          @endif

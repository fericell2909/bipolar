                    ...
                    <tbody>
                      <tr>
                        <td class="column_cell tc" style="box-sizing: border-box;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;padding-left: 8px;padding-right: 8px;font-family: Arial, Helvetica, sans-serif;font-size: 16px;color: #757575;text-align: center;line-height: inherit;">
                          ...
                          @endif
                          @if(\LaravelLocalization::getCurrentLocale() === 'es')
                          <p style="font-family: Arial, Helvetica, sans-serif;font-size: 16px;color: #000000;line-height: 23px;mso-line-height-rule: exactly;margin-top: 0;margin-bottom: 20px;">Únete a nuestra lista exclusiva de whatsapp escríbenos <a href="https://api.whatsapp.com/send?phone=51965367385&amp;text=Hola%21%20Quisiera%20m%C3%A1s%20informaci%C3%B3n%20sobre%20Tus%20Servicios%20" target="_blank" style="font-weight: bold; text-decoration: underline;">aquí</a></p>
                          @elseif(\LaravelLocalization::getCurrentLocale() === 'en')
                          <p style="font-family: Arial, Helvetica, sans-serif;font-size: 16px;color: #000000;line-height: 23px;mso-line-height-rule: exactly;margin-top: 0;margin-bottom: 20px;">Join our exclusive WhatsApp list by writing to us <a href="https://api.whatsapp.com/send?phone=51965367385&amp;text=Hola%21%20Quisiera%20m%C3%A1s%20informaci%C3%B3n%20sobre%20Tus%20Servicios%20" target="_blank" style="font-weight: bold; text-decoration: underline;">here</a></p>
                          @endif

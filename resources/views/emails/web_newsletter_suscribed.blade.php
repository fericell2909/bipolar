          ...
          <tbody>
            <tr>
              <td>
                ...
                <img src="{{ asset('bipolar-images/assets/mails/suscription_esp.png') }}" style="max-width: 100%" alt="Bipolar">
                @elseif(\LaravelLocalization::getCurrentLocale() === 'en')
                <img src="{{ asset('bipolar-images/assets/mails/suscription_eng.png') }}" style="max-width: 100%" alt="Bipolar">
                @endif
              </td>
            </tr>
            <tr>

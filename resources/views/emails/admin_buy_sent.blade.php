                    ...
                    <tr>
                      <td class="column_cell pt tc" style="box-sizing: border-box;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;padding-left: 8px;padding-right: 8px;font-family: Arial, Helvetica, sans-serif;font-size: 16px;color: #757575;text-align: center;padding-top: 16px;line-height: inherit;">
                        <table role="presentation" class="ic_h" align="center" width="80" border="0" cellspacing="0" cellpadding="0" style="box-sizing: border-box;mso-table-lspace: 0pt;mso-table-rspace: 0pt;border-spacing: 0;display: table;margin-left: auto;margin-right: auto;">
                          <tbody>
                            <tr>
                              <td class="default_b" style="box-sizing: border-box;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: middle;background-color: #000000;line-height: 100%;padding: 16px;text-align: center;mso-line-height-rule: exactly;border-radius: 100px;">
                                <img role="img" src="{{ asset('images/shopping-cart.svg') }}" width="48" height="48" alt="Heart symbol" style="max-width: 48px;outline: none;border: 0;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;line-height: 100%;">
                              </td>
                            </tr>
                          </tbody>
                        </table>
                        ...
                        <p class="lead mb tm" style="font-family: Arial, Helvetica, sans-serif;font-size: 20px;color: #b3b3b3;line-height: 27px;mso-line-height-rule: exactly;margin-top: 0;margin-bottom: 16px;">
                          Puede confirmar el estado de su pedido en el siguiente enlace
                        </p>

              ...
              <tr>
                <td>
                  <a href="{{ route('confirmation', $buy->id) }}">
                    @if(\LaravelLocalization::getCurrentLocale() === 'es')
                      <img src="{{ bipolar_mail_asset_url('storage/bipolar-images/assets/mails/spa_order_sent.png', $message) }}" style="max-width: 100%" alt="Bipolar">
                      @elseif(\LaravelLocalization::getCurrentLocale() === 'en')
                      <img src="{{ bipolar_mail_asset_url('storage/bipolar-images/assets/mails/eng_order_sent.png', $message) }}" style="max-width: 100%" alt="Bipolar">
                    @endif
                  </a>
                </td>
              </tr>

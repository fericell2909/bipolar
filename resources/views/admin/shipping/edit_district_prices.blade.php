...
@section('title', "Editar precios de zona de envío distrito ")
@section('content')
  <div class="row">
    <div class="col-md">
      <a href="{{ route('settings.shipping.edit', 5) }}" class="card text-center">
        <div class="card-body">
    ...
    <div class="col-md">
      <a href="{{ route('settings.shipping.edit.price', 5) }}" class="card text-center text-white bg-primary">
        <div class="card-body">
          ...
          <tbody>
              @if(count($shippings) > 0)
                @foreach($shippings as $shipping)
                    <tr>   
                        <td>{{$shipping->district->nombre}}</td> 
              ...
              @else
                    @foreach($districts as $district)
                        <tr> 
                            @if($district->id % 2 > 0)
                                <td class="align-middle class=align-middle" rowspan="12" 
                                    style="background-color: #fb9678; color: white; ; text-align:center;"> 
                                        {{ $district->nombre }}
                                </td>
                            @else
                                <td class="align-middle class=align-middle" rowspan="12" 
                                    style="color: #fb9678; text-align:center;"> 
                                        {{ $district->nombre }}
                                </td>
                            @endif
                            <td class="align-middle class=align-middle"><strong>200g</strong></td>
                            <td class="align-middle">{!! Form::number('g200[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                            <td class="align-middle">{!! Form::number('g200_dolar[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                        </tr>
                        <tr>
                            <td class="align-middle"><strong>500g</strong></td>
                            <td class="align-middle">{!! Form::number('g500[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                            <td class="align-middle">{!! Form::number('g500_dolar[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                        </tr>
                        <tr>
                            <td class="align-middle"><strong>1kg</strong></td>
                            <td class="align-middle">{!! Form::number('kg1[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                            <td class="align-middle">{!! Form::number('kg1_dolar[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                        </tr>
                        <tr>
                            <td class="align-middle"><strong>2kg</strong></td>
                            <td class="align-middle">{!! Form::number('kg2[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                            <td class="align-middle">{!! Form::number('kg2_dolar[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                        </tr>
                        <tr>
                            <td class="align-middle"><strong>3kg</strong></td>
                            <td class="align-middle">{!! Form::number('kg3[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                            <td class="align-middle">{!! Form::number('kg3_dolar[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                        </tr>
                        <tr>
                            <td class="align-middle"><strong>4kg</strong></td>
                            <td class="align-middle">{!! Form::number('kg4[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                            <td class="align-middle">{!! Form::number('kg4_dolar[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                        </tr>
                        <tr>
                            <td class="align-middle"><strong>5kg</strong></td>
                            <td class="align-middle">{!! Form::number('kg5[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                            <td class="align-middle">{!! Form::number('kg5_dolar[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                        </tr>
                        <tr>
                            <td class="align-middle"><strong>6kg</strong></td>
                            <td class="align-middle">{!! Form::number('kg6[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                            <td class="align-middle">{!! Form::number('kg6_dolar[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                        </tr>
                        <tr>
                            <td class="align-middle"><strong>7kg</strong></td>
                            <td class="align-middle">{!! Form::number('kg7[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                            <td class="align-middle">{!! Form::number('kg7_dolar[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                        </tr>
                        <tr>
                            <td class="align-middle"><strong>8kg</strong></td>
                            <td class="align-middle">{!! Form::number('kg8[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                            <td class="align-middle">{!! Form::number('kg8_dolar[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                        </tr>
                        <tr>
                            <td class="align-middle"><strong>9kg</strong></td>
                            <td class="align-middle">{!! Form::number('kg9[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                            <td class="align-middle">{!! Form::number('kg9_dolar[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                        </tr>
                        <tr>
                            <td class="align-middle"><strong>10kg</strong></td>
                            <td class="align-middle">{!! Form::number('kg10[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                            <td class="align-middle">{!! Form::number('kg10_dolar[]', null, ['class' => 'form-control', 'step' => 'any']) !!}</td>
                        </tr>

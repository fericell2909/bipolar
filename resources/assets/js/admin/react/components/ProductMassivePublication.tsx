  ...
  updatePublishDate = () => {
    return swal({
      ...
      if (result.value) {
        ...
        await axios.post('/ajax-admin/products/publishdate', {
          productIds,
          publish_date: this.state.beginDate,
        });
        ...
        const updatedSelectedProducts = this.state.originalProducts.filter(product =>
